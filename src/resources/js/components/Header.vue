        ...
        <div class="max-w-5xl flex flex-wrap items-center mx-auto">
            ...
            <div class="flex ml-auto md:order-2">
                <ul v-show="!isLogin" id="nav-right" class="flex items-center">
                    <li>
                        <RouterLink to="/login" class="block cursor-pointer py-2 px-2 mr-2 text-xs bg-orange-500 hover:bg-orange-600 text-white rounded hover:text-gray-300 transition-colors md:px-4 md:text-base">ログイン</RouterLink>
                    </li>
                    <li>
                        <RouterLink to="/register" class="block cursor-pointer py-2 px-2 mr-4 text-xs bg-orange-500 hover:bg-orange-600 text-white rounded hover:text-gray-300 transition-colors md:px-4 md:text-base md:mr-0">新規登録</RouterLink>
                    </li>
                </ul>
                ...
                <div v-show="isLogin" class="flex items-center ml-auto mr-1 md:mr-0 md:order-2">
                    <button type="button" class="mr-1 text-sm bg-black cursor-pointer md:mr-0 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                        ...
                        <span class="text-white hover:text-gray-300 transition-colors">{{ username }}</span>
                    </button>
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                        ...
                        <ul class="py-1" aria-labelledby="user-menu-button">
                            <li>
                                <RouterLink to="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">マイページ</RouterLink>
                            </li>
                            <li>
                                <RouterLink to="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">設定</RouterLink>
                            </li>
                            <li>
                                <button v-show="isLogin" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white" @click.preventDefault="logout">ログアウト</button>
                            </li>
                        </ul>
                    </div>
                </div>
